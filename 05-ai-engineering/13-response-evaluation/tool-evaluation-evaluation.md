# Tool Evaluation in AI Systems

## 1. Definition & Core Concepts
Tool Evaluation is the process of testing an agent's ability to select the correct external tool (function calling) and format parameters according to schema requirements.

## 2. Why It Exists / What Problem It Solves
Agents interact with databases and APIs based on parameters they generate. Tool evaluation ensures that the model selects the right functions under various user queries and formats arguments without syntax errors.
