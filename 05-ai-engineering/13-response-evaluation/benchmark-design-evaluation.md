...
Benchmark Design is the process of building specialized, domain-specific evaluation suites and datasets used to measure model accuracy, latency, and security.

## 2. Why It Exists / What Problem It Solves
General benchmarks (e.g. MMLU, GSM8K) measure general model abilities but fail to reflect performance on specific company data (e.g. searching private support pages). Custom benchmarks evaluate models on target workloads.
