...
Automated Evaluation is the programmatically scheduled execution of test cases against model prompts during CI/CD steps to prevent regressions.

## 2. Why It Exists / What Problem It Solves
It replaces manual verification. Instead of developers manually checking model outputs, the CI/CD pipeline runs automated batch tests on every code push, checking for format compliance, toxicity, and grounding.
