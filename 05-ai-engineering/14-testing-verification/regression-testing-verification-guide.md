...
Regression Testing is the process of verifying that modifications to prompt templates, model updates, or codebase logic do not degrade the accuracy, safety, or formatting of existing AI features.

## 2. Why It Exists / What Problem It Solves
AI models are non-deterministic. Tweaking a prompt to improve one specific user flow can break others. Regression testing runs automated batches of test cases to verify overall quality.
