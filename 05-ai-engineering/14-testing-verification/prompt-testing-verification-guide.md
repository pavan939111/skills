...
Prompt Testing is the process of validating prompt templates against a golden dataset (a curated list of test prompts and target answers) to measure accuracy, safety, and formatting compliance before release.

## 2. Why It Exists / What Problem It Solves
AI updates are non-deterministic. Tweaking a prompt to improve one user flow can break others. Testing pipelines run automated batches of test cases to verify that prompt changes do not introduce regressions.
