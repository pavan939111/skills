...
Agent Permission Models are authorization frameworks that define, enforce, and audit the specific tools, directories, database tables, and API routes an AI agent is permitted to access during task execution.

## 2. Why It Exists / What Problem It Solves
AI agents select and execute tools dynamically based on context. Without permission models, a prompt injection attack can hijack the agent to run dangerous actions, leak data, or drop databases.
